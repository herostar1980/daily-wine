...
<?PHP 
session_start();
include('../showPHP/check_login.PHP'); 
?>
<body>
    <header>
        <!-- Header Start -->
    ...
    <main>
        ...
        <?PHP  if(isset($_SESSION['sid']) && ($_SESSION['sid'] > 0)) { ?>
            Xin chào : <?PHP echo $_SESSION['sName'] ?>
            <br>
            <?PHP if($_SESSION['sRole']== 1 ) 
            { 

                echo " <a class='btn_1 checkout_btn_1' href='../../admin'>Đến trang admin</a>";
            ...
            <div class="col-lg-6 col-md-6">
                            ...
                            <div class="login_part_form_iner">
                                <form class="row contact_form" action="login.php" method="post" novalidate="novalidate">     
                                    <div class="col-md-12 form-group">                             
                                        <br><br>
                                        <button type="submit" value="submit" name="logout" class="btn_3">
                                            LOG OUT
                                        </button>                            
                                    </div>
                                </form>                              
                    ...
                    <?PHP if(isset($_POST['logout']) && ($_POST['logout'])) {
                            session_destroy();
                    }?>
            <?PHP } else {  ?>
